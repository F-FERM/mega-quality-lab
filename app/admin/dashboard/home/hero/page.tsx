...
// Single source of truth for the API route. All CRUD calls (list, create,
// update, delete) hit this same resource so behavior can't drift between
// operations.
const ENDPOINT = "/home";
...
// - GET  /testing-hero      -> TestingHero[]            (list)
// - GET  /testing-hero/:id  -> TestingHero               (single object, bare)
// Some backends also wrap the list as { testingHeroes: [...] } — handled too,
// just in case the list route ever changes shape.
...
function parseTestingHeroList(data: unknown): TestingHero[] {
  ...
  // GET by id (and some singleton-style list endpoints) return the hero
  // object directly, unwrapped. Treat it as a one-item list.
...
/** Strips the Mongo _id and normalizes inlineLinks before sending a card to the API. */
      ...
      <div className="mx-auto flex max-w-[1600px] flex-col gap-[16px] sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-[6px] text-[13px] leading-[1.6] text-[#666666] sm:text-[14px] lg:text-[15px]">
            Manage the testing page hero and feature cards.
          </p>
        </div>
              ...
              <div className="mt-[18px] space-y-[14px] sm:mt-[22px] sm:space-y-[16px]">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-[10px] xs:grid-cols-3">
                    <Input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, heroTitleOne: e.target.value })
                      }
                      placeholder="Line 1"
                      className="h-[46px] rounded-[12px] border-[#E4E4E4] bg-white text-[14px] focus-visible:ring-[#67003E]/30 sm:h-[48px]"
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, heroTitleTwo: e.target.value })
                      }
                      placeholder="Line 2"
                      className="h-[46px] rounded-[12px] border-[#E4E4E4] bg-white text-[14px] focus-visible:ring-[#67003E]/30 sm:h-[48px]"
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, heroTitleThree: e.target.value })
                      }
                      placeholder="Line 3"
                      className="h-[46px] rounded-[12px] border-[#E4E4E4] bg-white text-[14px] focus-visible:ring-[#67003E]/30 sm:h-[48px]"
                    />
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setForm({ ...form, heroDescriptionTwo: e.target.value })
                    }
                    rows={3}
                    className="rounded-[12px] border-[#E4E4E4] bg-white text-[14px] focus-visible:ring-[#67003E]/30"
                  />
                ...
                <div className="grid grid-cols-1 gap-[12px] xs:grid-cols-2">
                  <FormField
                    ...
                    onChange={(value) =>
                      setForm({ ...form, requestTestButtonText: value })
                    }
                  />
                  <FormField
                    ...
                    onChange={(value) =>
                      setForm({ ...form, requestTestButtonLink: value })
                    }
                  />
                  <FormField
                    ...
                    onChange={(value) =>
                      setForm({ ...form, exploreServicesButtonText: value })
                    }
                  />
                  <FormField
                    ...
                    onChange={(value) =>
                      setForm({ ...form, exploreServicesButtonLink: value })
                    }
                  />
                </div>
                    ...
                    <div className="mt-[12px] space-y-[10px] rounded-[12px] border border-[#D4B8A8] bg-[#F8F0F5] p-[12px]">
                      ...
                      <div className="grid grid-cols-2 gap-[10px] xs:grid-cols-4">
                        <Input
                          ...
                          onChange={(e) =>
                            setCardDraft((prev) => ({ ...prev, number: e.target.value }))
                          }
                          placeholder="01"
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setCardDraft((prev) => ({ ...prev, label: e.target.value }))
                          }
                          placeholder="Label"
                          className="h-[44px] rounded-[10px] border-[#E4E4E4] bg-white text-[13px]"
                        />
                        <Input
                          ...
                          onChange={(e) =>
                            setCardDraft((prev) => ({ ...prev, title: e.target.value }))
                          }
                          placeholder="Title"
                          ...
                          <p className="text-[10px] font-medium uppercase tracking-wide text-[#67003E]">
                            ...
                            {(card.inlineLinks?.length ?? 0) > 0 && (
                              <span className="ml-2 text-[#67003E]">
                                • {card.inlineLinks!.length} link
                                {card.inlineLinks!.length !== 1 ? "s" : ""}
                              </span>
                            )}
                          </p>
          ...
          >
            ...
            >
              ...
              <p className="mt-[8px] text-[13px] leading-[1.6] text-[#666666]">
                This will remove &quot;{deleteTarget.heroTitleOne}&quot; and its
                feature cards.
              </p>
